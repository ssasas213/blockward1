...
export default function Layout({ children, currentPageName }) {
  ...
  const navigationItems = {
    admin: [
      ...
      { name: 'Attendance', icon: Calendar, page: 'Attendance', permission: 'view_reports' },
      { name: 'Grade Book', icon: BookOpen, page: 'GradeBook', permission: 'view_reports' },
      { name: 'Analytics', icon: BarChart3, page: 'Analytics', permission: 'view_reports' },
