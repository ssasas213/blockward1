    ...
    >
      ...
      >
        ...
        <div className="absolute top-3 right-3 flex items-center gap-1.5">
          {isVerified && (
            <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-success/25 border border-success/50 text-[11px] font-semibold text-success shadow-[0_0_12px_hsl(142_71%_45%/0.35)]">
              <ShieldCheck className="h-3 w-3" /> Verified
            </span>
          )}
          <span className={cn("px-2 py-0.5 rounded-md text-[11px] font-medium  border", rarity.badge)}>
            {rarity.name}
          </span>
        </div>
